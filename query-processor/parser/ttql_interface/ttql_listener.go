...
// TTQLListener is a complete listener for a parse tree produced by TTQLParser.
type TTQLListener interface {
	antlr.ParseTreeListener

	// EnterTtQL is called when entering the ttQL production.
	EnterTtQL(c *TtQLContext)

	// EnterTtQL_Statement is called when entering the ttQL_Statement production.
	EnterTtQL_Statement(c *TtQL_StatementContext)

	// EnterTtQL_Query is called when entering the ttQL_Query production.
	EnterTtQL_Query(c *TtQL_QueryContext)

	// EnterTtQL_TimeClause is called when entering the ttQL_TimeClause production.
	EnterTtQL_TimeClause(c *TtQL_TimeClauseContext)
	...
	// ExitTtQL is called when exiting the ttQL production.
	ExitTtQL(c *TtQLContext)

	// ExitTtQL_Statement is called when exiting the ttQL_Statement production.
	ExitTtQL_Statement(c *TtQL_StatementContext)

	// ExitTtQL_Query is called when exiting the ttQL_Query production.
	ExitTtQL_Query(c *TtQL_QueryContext)

	// ExitTtQL_TimeClause is called when exiting the ttQL_TimeClause production.
	ExitTtQL_TimeClause(c *TtQL_TimeClauseContext)
